        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Stock Pusat',
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url'  => 'admin/item/stock/view/hq/available',
                    'can'  => 'view-stock-item'
                ],
                [
                    'text' => 'Stock Mitra',
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url'  => 'admin/item/stock/view/partner/available',
                    'can'  => 'view-stock-item'
                ],
            ],
        ],
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Transfer',   
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url' => 'admin/sell/view/Transfer'
                ],
                [
                    'text' => 'Retur',   
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url' => 'admin/sell/view/Retur'
                ],
            ]
        ],
        [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Batch Mitra',
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url'  => 'admin/master/batch-mitra',
                    'can' => 'view-group'
                ],
                [
                    'text' => 'Wilayah Mitra',
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url' => 'admin/master/wilayah',  
                    'can' => 'view-zone'
                ],
                [
                    'text' => 'List Rak',
