...
@section('content')
    <div class="card card-primary">
        <form method="POST" action="{{ route('buy.store') }}" id='theForm' enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="SPNo" id="SPNo" class="form-control" placeholder="Masukkan nomor SP...">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="SPDate">Tanggal SP:</label>
                            <input type="datetime-local" name="SPDate" id="SPDate" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="approveDate">Tanggal Approve:</label>
                            <input type="datetime-local" name="approveDate" id="approveDate" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="sendDate">Tanggal Kirim:</label>
                            <input type="datetime-local" name="sendDate" id="sendDate" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="receiveDate">Tanggal Terima:</label>
                            <input type="datetime-local" name="receiveDate" id="receiveDate" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
